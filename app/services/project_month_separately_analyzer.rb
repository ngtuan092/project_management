class ProjectMonthSeparatelyAnalyzer < Patterns::Service
  ...
  def value_resources_months
    ...
    month_number_displayed(start_month_year, end_month_year).each do |ele|
      hash_out[ele.reverse.join "-"] = value_resources_month ele
    end
  ...
  def value_resources_year project_month
    # sum all value 12 month 1 + 2 + 3 ... of project
  ...
  def value_resources_month month_year
